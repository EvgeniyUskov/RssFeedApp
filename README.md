...
Без Rx (включая SwiftUI + Combine), т.к на проекте он не используется Не использовать storyboard и xib  Если новость прочитана - маркируется цветом.  Должна быть возможность добавления, выбора источника и вывода новостей из нескольких источников одновременно.  Код должен соответствовать принципам SOLID  Примеры url адресов: https://www.finam.ru/net/analysis/conews/rsspoint https://www.banki.ru/xml/news.rss
